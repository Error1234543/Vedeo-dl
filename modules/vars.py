...
BOT_TOKEN = environ.get("BOT_TOKEN", "8471869483:AAEB3EdtPQ3lW7lAhUdPXNLuB51nrSMtlqA")

OWNER = int(environ.get("OWNER", "5680454765"))
CREDIT = environ.get("CREDIT", "S P I D Y")
cookies_file_path = os.getenv("cookies_file_path", "youtube_cookies.txt")

TOTAL_USER = os.environ.get('TOTAL_USERS', '8226637107').split(',')
